  ...
  run: function (options) {
    return new Promise((resolve, reject) => {
      ...
      if (options.host) {
        ...
        // TO DO: do? Possibly was removed at some point.
      }
      ...
      fs.writeFileSync(targetImportJSON, JSON.stringify(appImport, null, this.settings.config.jsonFileIndent));
      ...
      var metaResources = JSON.parse(fs.readFileSync(options.source + 'resources/resources.jsonld'));
      ...
      debug(appResources);
      fs.writeFileSync(targetFixtures + 'resources/resources.jsonld', JSON.stringify(appResources, null, this.settings.config.jsonFileIndent));
