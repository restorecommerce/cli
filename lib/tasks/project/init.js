...
const projectsFileName    = '/.restore-commerce-projects.json';
const credentialsFileName = '/.restore-commerce-credentials.json';
...
module.exports = Task.extend({
	run: function(options) {
		...
		const projectsPath = options.base + projectsFileName;
		const credentialsPath = options.base + credentialsFileName;
