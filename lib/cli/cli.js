...
RSTC.prototype.handleArguments = function(env) {
	...
	// Pass this around in every created sub-command.
	const command = new _command({
		...
		project: this.environment.project,
		settings: this.environment.settings, // Currently not used like in ember-cli.
		testing: this.testing,
		cli: this
	});

	command.validateAndRun(this.commandArgs).then(function(result) {
