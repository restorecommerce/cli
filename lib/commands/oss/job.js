...
module.exports = Command.extend({
	...
	availableOptions: [
		...
		{ name: 'entry', 			type: String, 	default: 'Resolved project\'s endpoint.',	aliases: ['e']				},
		{ name: 'apikey',			type: String,		default: 'Resolved project\'s API key.',	aliases: ['key', 'k']	},
		{ name: 'diff',				type: Boolean,	default: false, 													aliases: ['d']				},
		{ name: 'diff-base',	type: String,		default: undefined, 											aliases: ['df']				},
		{ name: 'diff-cb',		type: Function,	default: undefined, 											aliases: ['db']				}
	],
