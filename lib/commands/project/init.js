...
module.exports = Command.extend({
	...
	works: 'everywhere',
	availableOptions: [
		{ name: 'id',    	type: String, default: undefined, 												description: 'Application\'s ID.'																															 },
		{ name: 'entry', 	type: String, default: undefined, aliases: ['e'],					description: 'Applicatio\'s entry oint.'																								       },
