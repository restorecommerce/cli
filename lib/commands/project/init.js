...
module.exports = Command.extend({
	...
	availableOptions: [
		...
		{ name: 'entry', 	type: String, default: undefined, aliases: ['e']																																														},
		{ name: 'base',  	type: String, default: undefined, aliases: ['b'],					description: 'Defaults to current working directory.'															},
		{ name: 'apikey',	type: String,	default: undefined, aliases: ['key', 'k'],	description: 'API key for the credentials file. Gets generated if not provided.'	}
	],
	...
	run: function(commandOptions, rawArgs) {
		...
		/* TO DO?: 
			Validate commandOptions.entry 	(check if valid?)
			Validate commandOptions.apikey 	(check if not a duplicate?)
		*/
