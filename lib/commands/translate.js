...
module.exports = Command.extend({
  ...
  run: function (commandOptions, rawArgs) {
    ...
    if (!commandOptions.dest) {
      const message = 'Destination directory not specified. Defaulting to \'' + i18nDestDir + '\'.';
      console.log(message);
      if (!commandOptions.entry) {
        console.log('Are you sure you just wanted to translate the resources to \'' + i18nDestDir + '\'?');
      }
    }
